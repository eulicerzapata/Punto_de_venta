                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 mb-3">
                            ...
                            <input class="form-control" id="monto_inicial" name="monto_inicial" type="text" value="<?php echo $arqueo['monto_inicial']; ?>" required autofocus>
                        </div>

                        <div class="col-12 col-sm-6 mb-3">
                            <label>Monto final</label>
                            <input class="form-control" id="monto_final" name="monto_final" type="text" value="" required autofocus>
                        </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 mb-3">
                            ...
                            <input class="form-control" id="monto_inicial" name="monto_inicial"
                             type="text" value="<?php echo $monto['total']  ?>" required autofocus>
                        </div>

                        <div class="col-12 col-sm-6 mb-3">
                            <label>Total de ventas</label>
                            <input class="form-control" id="total_ventas" name="total_ventas" type="text" value="" required autofocus>
                        </div>
