            ...
            <form method="POST" action="<?php echo base_url(); ?>/cajas/insertar" autocomplete="off">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-12 col-sm-6 mb-3">
                            ...
                            <input class="form-control" id="numero_caja" name="numero_caja" type="text" autofocus required>
                        </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 mb-3">
                            <label>Folio</label>
                            <input class="form-control" id="folio" name="folio" type="text" autofocus required>
                        </div>
