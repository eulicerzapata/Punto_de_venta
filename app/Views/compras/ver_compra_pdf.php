            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="panel">
                    <div class="embed-responsive embed-responsive-16by9" style="margin: 30px">
                        <iframe class="embed-resposive-item" src=" <?php echo base_url() . "/compras/
generaCompraPdf/" . $id_compra ?>"></iframe>
                    </div>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <iframe src=" <?php echo base_url() . "/compras/
generaCompraPdf/" . $id_compra; ?>" width="100%" height="600px"></iframe>
                </div>
