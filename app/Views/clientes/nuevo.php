                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 mb-3">
                            ...
                            <input class="form-control" id="telefono" name="telefono" type="text" autofocus required>
                        </div>

                        <div class="col-12 col-sm-6 mb-3">
                            <label>correo</label>
                            <input class="form-control" id="correo" name="correo" type="text" autofocus required>
                        </div>
